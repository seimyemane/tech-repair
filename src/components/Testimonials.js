...
const Testimonials = () => {
  return (
    <section className=" flex flex-col justify-center items-center lg:h-[100vh] md:h-[100vh]  h-[100%] w-full ">
      ...
      <div className=" lg:w-[80%] md:w-[80%] w-full bg-no-repeat bg-cover  bg-[url('/src/images/testimonialBG.jpg')] flex flex-wrap justify-around p-2   items-center  lg:text-2xl md:text-2xl text-lg  h-[100%] gap-6 ">
        {/* testimonial 1 */}
        <div className="p-4 lg:h-1/3 md:h-fit  lg:w-1/3 md:w-1/3 w-fit bg-slate-600 bg-opacity-25 rounded-2xl shadow-md   flex justify-center items-start flex-col text-neutral-200 italic text-wrap h-1/5 ">
        ...
        {/* testimonial 2 */}
        <div className=" p-4 lg:h-1/3 md:h-fit   lg:w-1/3 md:w-1/3 w-fit bg-slate-800 bg-opacity-35 rounded-2xl shadow-md   flex justify-center items-start flex-col text-neutral-200 italic text-wrap">
          <p className="  ">
